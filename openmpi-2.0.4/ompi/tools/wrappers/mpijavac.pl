...
my $my_compiler = "/opt/homebrew/opt/openjdk/bin/javac";
my $mpi_jar   = "/Users/josepbaratech/opt/usr/local/lib/mpi.jar";
my $shmem_jar = "/Users/josepbaratech/opt/usr/local/lib/shmem.jar";
